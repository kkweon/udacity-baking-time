...
public class DetailStepItemActivity extends AppCompatActivity
        implements DetailStepItemFragment.OnNavClickListener {
    ...
    public void onClickPrev(RecipeStep recipeStep) {
        Intent intent =
                getNextStateIntent(recipeStep, ExtraNavButtonClickEvent.PREV_BUTTON_CLICKED);
    ...
    public void onClickNext(RecipeStep recipeStep) {
        Intent intent =
                getNextStateIntent(recipeStep, ExtraNavButtonClickEvent.NEXT_BUTTON_CLICKED);
        setResult(RESULT_OK, intent);
        finish();
    }

    @NotNull
    private Intent getNextStateIntent(
            RecipeStep recipeStep, ExtraNavButtonClickEvent nextButtonClicked) {
